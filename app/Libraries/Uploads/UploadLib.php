...
class UploadLib
{
     ...
     * @param string $disk
     * @param string $pathToFile
     * @param false|\Image $imageInstance
     * @param boolean $watermark
     */
    public static function fileAllowToCreateThumbnail($extension, $disk, $pathToFile, $imageInstance = false, $watermark = false)
    {
        ...
        if ($extension && in_array($extension, [
            ...
            if ($imageInstance) {
                ...
                $image = \Image::make(\Storage::disk($disk)->get($pathToFile));
            }
            self::thumbnail($image, $disk, $pathToFile, $watermark);
        }
