...
trait UploadTrait
{
     ...
     */
    public function myCrudUpload($value, $attribute_name, $destination_path, $disk = 'uploads', $thumbnail = true, $mainImage = true)
    {
        $request = \Request::instance();
        if ($request->hasFile($attribute_name)) {
            $this->myUploadFileToDisk($value, $attribute_name, $disk, $destination_path, $thumbnail, $mainImage);
        } else {
            if ($value == null) {
     ...
     * @param boolean $mainImage
     */
    public function myCrudUploads($value, $attribute_name, $destination_path, $disk = 'uploads', $thumbnail = true, $mainImage = true)
    {
        $request = \Request::instance();
        ...
        if ($request->hasFile($attribute_name)) { // tested
            $this->myUploadMultipleFilesToDisk($value, $attribute_name, $disk, $destination_path, $thumbnail, $mainImage);
        } else {
            $attribute_value = $this->attributeValueToArray($this->{$attribute_name});
            $files_to_clear = $request->get('clear_' . $attribute_name);
            $attribute_value = $this->filesToClear($files_to_clear, $attribute_value, $disk);
    ...
    public function myUploadFileToDisk($value, $attribute_name, $disk, $destination_path, $thumbnail = true, $mainImage = true)
    {
    ...
    public function myUploadMultipleFilesToDisk($value, $attribute_name, $disk, $destination_path, $thumbnail = true, $mainImage = true)
    {
        $request = \Request::instance();
        $attribute_value = $this->attributeValueToArray($this->{$attribute_name});
        $files_to_clear = $request->get('clear_' . $attribute_name);
     ...
     * @return array
     */
    protected function filesToClear($files_to_clear, $attribute_value, $disk = 'uploads')
    {
