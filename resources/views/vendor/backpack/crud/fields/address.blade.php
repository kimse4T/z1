...
<div class="form-group col-md-12 mb-0">
    ...
    <div class="row" id="{{ $uniqueId }}">
        <div class="col-sm-6 col-md-6 mb-3">
            <label>Province/City @if($setRequired >= 7) <span class="label-required">*</span> @endif </label>
        ...
        <div class="col-sm-6 col-md-6 mb-3">
            <label>District/Khan @if($setRequired >= 7) <span class="label-required">*</span> @endif </label>
        ...
        <div class="col-sm-6 col-md-6 mb-3">
            <label class="no-error-label">Commune/Sangkat @if($setRequired >= 7) <span class="label-required">*</span> @endif </label>
        ...
        <div class="col-sm-6 col-md-6 mb-3">
            <label class="no-error-label">Village/Phum @if($setRequired >= 7) <span class="label-required">*</span> @endif </label>
            ...
            new Vue({
                ...
                methods:{
                    ...
                    getData:function(code=''){
                        ...
                        if(code)
                            return axios.get('{{route("address.index")}}/'+code)
                        else
