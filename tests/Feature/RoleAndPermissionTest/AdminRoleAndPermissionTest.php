...
class AdminRoleAndPermissionTest extends TestCase
{
    ...
    /** @test */
    public function what_admin_can_see()
    {
    ...
    /** @test */
    public function admin_can_list_user()
    {
        $this->get('/admin/user')
             ->assertStatus(200)
    ...
    /** @test */
    public function admin_can_list_role()
    {
        $this->get('/admin/role')
             ->assertStatus(200)
             ->assertViewIs('crud::list');
    ...
    public function admin_can_update_role()
    {
        ...
        $this->put('/admin/role/'.$role->id,["name"  => \Str::random(4),'id' => $role->id])
             ->assertStatus(302);
    }
    ...
    /** @test */
    public function admin_can_list_permission()
    {
    ...
    public function admin_can_update_permission()
    {
        ...
        $this->put('/admin/permission/'.$permission->id,["name"  => \Str::random(4),'id' => $permission->id])
             ->assertStatus(302);
    }
    ...
    /** @test */
    public function admin_can_list_contact()
    {
    ...
    /** @test */
    public function admin_can_show_contact()
    {
    ...
    /** @test */
    public function admin_can_list_account()
    {
    ...
    /** @test */
    public function admin_can_show_account()
    {
    ...
    /** @test */
    public function admin_can_list_property()
    {
    ...
    /** @test */
    public function admin_can_show_property()
    {
